...
Looks like it's a normal image. Then, check the image metadata.
...
Directory                       : .
File Size                       : 636 KiB
File Modification Date/Time     : 2023:08:05 22:11:39+07:00
File Access Date/Time           : 2023:08:05 22:12:26+07:00
File Inode Change Date/Time     : 2023:08:05 22:12:22+07:00
...
Nothing suspicious. Let's see what's inside the image.
...
Now we know that the file contains a zip file that contains another image. Extract the zip file until we got the `flag.txt` file using `binwalk -e <image_name>.jpg`.
